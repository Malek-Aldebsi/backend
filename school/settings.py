...
DATABASE_FILES_DIR = os.path.join(BASE_DIR, 'database')
...
ALLOWED_HOSTS = os.getenv("DJANGO_ALLOWED_HOSTS", "127.0.0.1, localhost, kawkab-tawjihi-syvbe.ondigitalocean.app").split(",")
